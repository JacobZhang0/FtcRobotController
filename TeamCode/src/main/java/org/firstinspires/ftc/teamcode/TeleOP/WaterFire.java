...
@TeleOp(name = "WaterFire", group = "TeleOP")
public class WaterFire extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double liftPower;
        double armPosition = MIN_ARM_POSITION;
        double bucketPosition = MIN_BUCKET_POSITION;
        double pixel_releasePosition = MIN_PIXEL_RELEASE_POSITION;
        double check1 = 0;
        double check2 = 0;
        ...
        while (opModeIsActive()) {
            ...
            if(ARM_GAMEPAD.right_trigger>0.5){
                ...
                bucketPosition = MAX_BUCKET_POSITION;
            }
            else if(ARM_GAMEPAD.left_bumper){
                arm.setPosition(MIN_ARM_POSITION);
                armPosition = MIN_ARM_POSITION;
                bucket.setPosition(MIN_BUCKET_POSITION);
                bucketPosition = MIN_BUCKET_POSITION;
            }
            ...
            telemetry.addData("Arm Port Number", arm.getPortNumber());
